...
// Entity: performance_feedback (careerhub)
...
export interface PerformanceFeedbackListFilters extends BaseListFilters {
...
export type PerformanceFeedbackList = ListEnvelope<PerformanceFeedback>;
export type PerformanceFeedbackBatch = BatchResponse<PerformanceFeedback>;
